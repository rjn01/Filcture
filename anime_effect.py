...
if __name__ == '__main__':
    ...
    #reading the image
    image = cv2.imread("/home/rjn/Pictures/My Pictures/rajan.jpeg")
    ...
    cv2.imwrite("assets/rjn.jpg", output) # save the image
    cv2.imwrite("assets/rjn_effect.jpg", output2) 
    cv2.imwrite("assets/rjn_anime_effect.jpg", output3) 
    cv2.imwrite("assets/rjn_vintage_effect.jpg", output4)
